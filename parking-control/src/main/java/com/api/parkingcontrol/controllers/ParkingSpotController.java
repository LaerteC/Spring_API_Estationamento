...
public class ParkingSpotController {
	...
	public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto){
		...
		if(parkingSpotService.existsByLicensePlateCar(parkingSpotDto.getLicensePlateCar())) {
			...
			return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflito : Licensa Plate Car is already in use !");
		}
		...
		parkingSpotModel.setRegitrationDate(LocalDateTime.now(ZoneId.of("UTC")));
...
//		parkingSpotModel.setRegitrationDate(parkingSpotModelOptional.get().getRegitrationDate());
